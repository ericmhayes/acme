...
#
# Composes the shared modules for the dev environment. Backend and provider are
# defined here; compute and delivery modules are added in later phases.
...
module "ci_oidc" {
  ...
  # dev creates the OIDC provider for the shared non-prod account.
